<!-- modal -->
        <div class="modal fade" id="tambahkategori" data-backdrop="static" data-keyboard="false">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <!-- form -->
                <form id="form1" class="form-horizontal" data-toggle="validator" action="<?php echo base_url('index.php/kategori/kategori_AddDB') ?>" method="post" autocomplete="off">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label" style="text-align: left;">Kategori</label>
                    <div class="col-sm-10">
